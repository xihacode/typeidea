...
class Link(models.Model):
    ...
    weight = models.PositiveIntegerField(default=1, choices=zip(range(1, 6), range(1, 6)),
                                         verbose_name="权重", help_text="权重高表示顺序靠前")
...
class SideBar(models.Model):
    ...
    content = models.CharField(max_length=200, blank=True, verbose_name="内容", help_text="如果设置的不是html类型，可为空")
